...
int main(int argc, char *argv[]){
...
#ifdef _WIN32
  string baseDir = "/home/tianluchao/ProgramFiles/mtcnn/data/";
  string listFile = "/home/tianluchao/ProgramFiles/mtcnn/data/FDDB-folds/foldList.txt";
  string detFile = "/home/tianluchao/ProgramFiles/mtcnn/data/FDDB-folds/predict.txt";
  string annotFile = "/home/tianluchao/ProgramFiles/mtcnn/data/FDDB-folds/ellipseList.txt";
#else
  string baseDir = "/home/tianluchao/ProgramFiles/mtcnn/data/";
  string listFile = "/home/tianluchao/ProgramFiles/mtcnn/data/FDDB-folds/foldList.txt";
  string detFile = "/home/tianluchao/ProgramFiles/mtcnn/data/FDDB-folds/predict.txt";
  ...
  string rocFilePrefix = "/home/tianluchao/ProgramFiles/mtcnn/data/FDDB-folds/temp"; 
  ...
  for(unsigned int ii = 0; ii < imNames->size(); ii++){
    ...
    // for(int kz=0;kz<imName.length();kz++)
    // {
    //    cout<<int(imName[kz]);
    // }
    // cout<<"\n"<<endl;
    ...
    string imS1;
    getline(fAnnot, imS1);
    imS1=imS1.substr(0,imS1.size()-1);
    // for(int kz=0;kz<imS1.length();kz++)
    // {
    //    cout<<int(imS1[kz]);
    // }
    // cout<<"\n"<<endl;
    ...
    string imS2;
    getline(fDet, imS2);
    // for(int kz=0;kz<imS2.length();kz++)
    // {
    //    cout<<int(imS2[kz]);
    // }
    // cout<<"\n"<<endl;
    ...
    // }
    // cout<<endl;
    // cout<<"imName length "<<imName.length()<<endl;
    // string imNamexxxx = imNames->at(2000);
    // cout<<"imNamexxxx length "<<imNamexxxx.length()<<endl;
    // for(int kz=0;kz<imNamexxxx.length();kz++)
    // {
        // cout<<int(imNamexxxx[kz]);
    // }
    // cout<<endl;
    // cout<<imName.compare(imS1)<<" "<< imS1.length()<<endl;
    // for(int kz=0;kz<imS1.length();kz++)
    // {
        // cout<<int(imS1[kz]);
    // }
    // cout<<endl;
    // cout<<imName.compare(imS2)<<" "<< imS1.length()<<endl;
    // for(int ky=0;ky<imS2.length();ky++)
    // {
        // cout<<int(imS2[ky]);
    // }
    // cout<<endl;
